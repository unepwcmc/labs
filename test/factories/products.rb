...
FactoryGirl.define do
  factory :product do
    ...
    factory :product_with_dependencies do
        after(:create) do |product|
            product.master_products << FactoryGirl.build(:product)
            product.sub_products << FactoryGirl.build(:product)
        end
    end

    factory :product_with_instances do
        transient do
          instances_count 2
        end
        ...
        after(:create) do |product, evaluator|
          create_list(
            :product_instance, evaluator.instances_count,
            product: product
          )
        end
    end
