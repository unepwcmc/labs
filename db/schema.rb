...
ActiveRecord::Schema.define(version: 20201208182117) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.float    "percentage_live_time_informatics"
    t.float    "percentage_live_time_codesign"
    t.float    "percentage_live_time_agency"
