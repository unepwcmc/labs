class AddFieldsToProjects < ActiveRecord::Migration
  def change
	...
	add_column :projects, :external_clients, :string, :array => true, :default => []
	add_column :projects, :project_leads, :string, :array => true, :default => []
	add_column :projects, :developers, :string, :array => true, :default => []
	add_column :projects, :pdrive_folders, :string, :array => true, :default => []
	add_column :projects, :dropbox_folders, :string, :array => true, :default => []
